...
namespace Drupal\ai_account\Services;
 ...
 */
class AIAccountNotifyFavoriteService {
   ...
   */
  public static function notifyAccountTermFavorite($key, $params = []) {
    $mailManager = \Drupal::service('plugin.manager.mail');
    $module = 'ai_account';
    $langcode = 'en';
    $send = TRUE;
    $from = 'aigallerycentralteam.fr@capgemini.com';
    // $to = 'dataandai-gallery.in@capgemini.com';
